...
public class MaximumContinuousDurationForResourceConstraintTest extends BaseTest {
    ...
    public void propertyChange() {
        ...
        Constraint maximumDurConstraint = new MaximumContinuousDurationForResourceConstraint(cond, new Duration("00:00:50"), "maximumDurViolated", ViolationSeverity.ERROR);
        ResourceA.set(98.7);
        ...
        maximumDurConstraint.finalizeConstraintAfterModeling();

        assertEquals(new Time("2000-001T00:01:45"), maximumDurConstraint.listOfViolationBeginAndEndTimes.get(0).getKey());
        assertEquals(new Time("2000-001T00:03:20"), maximumDurConstraint.listOfViolationBeginAndEndTimes.get(0).getValue());
    }
}